...
class TabletCertificateScreen extends StatefulWidget {
  const TabletCertificateScreen({super.key});

  @override
  State<TabletCertificateScreen> createState() =>
      _TabletCertificateScreenState();
}

class _TabletCertificateScreenState extends State<TabletCertificateScreen> {
