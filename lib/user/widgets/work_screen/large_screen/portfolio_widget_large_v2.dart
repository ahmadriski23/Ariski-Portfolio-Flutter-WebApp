...
class PortfolioLargeWidgetVolume2 extends StatefulWidget {
  const PortfolioLargeWidgetVolume2({super.key});

  @override
  State<PortfolioLargeWidgetVolume2> createState() =>
      _PortfolioLargeWidgetVolume2State();
}

class _PortfolioLargeWidgetVolume2State
    extends State<PortfolioLargeWidgetVolume2> {
