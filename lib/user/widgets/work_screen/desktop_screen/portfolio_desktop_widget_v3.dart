...
class PortfolioDesktopWidgetVolume3 extends StatefulWidget {
  const PortfolioDesktopWidgetVolume3({super.key});

  @override
  State<PortfolioDesktopWidgetVolume3> createState() =>
      _PortfolioDesktopWidgetVolume3State();
}

class _PortfolioDesktopWidgetVolume3State
    extends State<PortfolioDesktopWidgetVolume3> {
